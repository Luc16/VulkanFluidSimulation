...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("../src/ComputeShaderTest/Shaders/default.vert.spv");
        auto fragShaderCode = readFile("../src/ComputeShaderTest/Shaders/default.frag.spv");
    ...
    void createComputePipeline() {
        auto computeShaderCode = readFile("../src/ComputeShaderTest/Shaders/default.comp.spv");
